      ...
      <aside className="w-full md:w-1/3 px-3">
        ...
        <div className="bg-white shadow rounded-lg p-6 mb-4">
          ...
          <div className="text-md mt-6 flex items-center">
            ...
            {/* Blog content below slideshow and author info */}
            <div className="flex justify-center items-center max-w-4xl px-6 py-4">
                <p className="text-gray-700 pb-6">{descriptionText}</p>
            </div>
        </>
    );
}
