...
export default function BlogTemplate({ data }: { data: any }) {
    ...
    return (
        <>
            ...
            <div className="container mx-auto flex flex-wrap py-6">
                <div className="w-full md:w-2/3 px-3 relative">
                    {images.length > 0 && (
                ...
                <aside className="w-full md:w-1/3 px-3">
                    <div className="bg-white shadow p-6 mb-4">
                        ...
                        <h2 className="text-md font-italic text-gray-700">{data.subtitle}</h2>
                        <p className="text-sm pb-3">Published on {new Date(data.published_date).toDateString()}</p>
                    </div>
                    <div className="bg-white shadow p-6 mb-4">
                        <h3 className="text-xl flex flex-row items-center justify-center">
                            Tags: <p className="text-sm">
                        ...
                        <div className="text-md pb-3 flex flex-row mt-4">
