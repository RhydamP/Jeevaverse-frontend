...
let contactImage = "/assets/thumbnail/contactThumbnail.jpg"
const ContactUs = () => {
    return (
        <section className="py-24">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid lg:grid-cols-2 grid-cols-1">
                    <div className="lg:mb-0 mb-10 contact-thumbnail">
                                ...
                                <div className="absolute bottom-0 w-full lg:p-11 p-5">
                                    <div className="bg-white rounded-lg p-6 block">
                                        <a href="javascript:;" className="flex items-center mb-6">
                                            ...
                                            <h5 className="text-black text-base font-normal leading-6 ml-5">xxx-xxx-xxx</h5>
                                        </a>
                                        <a href="javascript:;" className="flex items-center mb-6">
                                            <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <h5 className="text-black text-base font-normal leading-6 ml-5">JeevaVerse@gmail.com</h5>
                                        ...
                                        <a href="javascript:;" className="flex items-center">
                                            ...
                                            <h5 className="text-black text-base font-normal leading-6 ml-5">Bangalore, Karnataka, India - 560037</h5>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl contact-detail">
                        <h2 className="text-lime-600 font-manrope text-4xl font-semibold leading-10 mb-11 contact-heading">Send Us A Message</h2>
                        ...
                        <button className="w-full h-12 text-white text-base font-semibold leading-6 rounded-full transition-all duration-700 hover:bg-lime-800 bg-lime-600 shadow-sm">Send</button>
                    </div>
                </div>
            </div>
        </section>
